...
<div class="auth-layout">
    ...
    <div class="auth-panel-left">
        ...
        <ul class="auth-feature-list">
            ...
            <li><span class="feat-icon"><i class="bi bi-clock"></i></span> Link expires in 60 minutes</li>
            <li><span class="feat-icon"><i class="bi bi-envelope-check"></i></span> Check your inbox and spam folder</li>
        </ul>
    </div>
