{{{-- ============================================================
     FILE: resources/views/superadmin/layout.blade.php
     ============================================================ --}}
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="sidebar" id="sidebar" style="background:#1e1b4b">
    <div class="sidebar-brand">
        <a href="{{ route('superadmin.dashboard') }}" class="brand-logo">
            <div class="brand-icon" style="background:#7c3aed"><i class="bi bi-shield-fill"></i></div>
            <div>
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="{{ route('superadmin.chamas') }}" class="nav-link {{ request()->routeIs('superadmin.chamas') ? 'active' : '' }}">
        ...
        <div class="nav-item">
            <a href="{{ route('superadmin.revenue') }}" class="nav-link {{ request()->routeIs('superadmin.revenue') ? 'active' : '' }}">
...
<div class="main-wrapper">
    ...
    <main class="page-content">
        @if(session('success'))
            <div class="alert-custom alert-success"><i class="bi bi-check-circle-fill"></i><span>{{ session('success') }}</span></div>
        @endif
        @if(session('error'))
            <div class="alert-custom alert-danger"><i class="bi bi-exclamation-circle-fill"></i><span>{{ session('error') }}</span></div>
        @endif
        @yield('content')
    </main>
</div>
